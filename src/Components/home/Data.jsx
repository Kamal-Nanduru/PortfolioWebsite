...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">N. Prasad
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I'm a young javascript developer searching for the finest chances to discover more about the software industry.</p>
